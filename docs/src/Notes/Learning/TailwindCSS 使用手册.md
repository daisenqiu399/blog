...
```html
<!-- Before -->
<button class="px-4 py-2 text-white sm:px-8 sm:py-3 bg-sky-700 hover:bg-sky-800">...</button>

<!-- After -->
<button class="px-4 py-2 text-white bg-sky-700 hover:bg-sky-800 sm:px-8 sm:py-3">...</button>
```
